...
def update_progress(message: str):
    ...
    with progress_container:
        ...
        if "complete" in message:
            ...
            st.write(f"{prefix} {message}")
    st.session_state.last_section = section  # <-- Move this here
...
# import streamlit as st
# from utils import run_agent_sync, ask_llm
...
#             st.header("Your Learning Path")
#             if result:
#                 # If result is a dict with 'output', use that; else just print result
